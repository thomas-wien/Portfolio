...
let projects = [
  ...
  new project("Weekly Planner", "HTML / SCSS / JSON / TypeScript", "Project description:", "In this Code Review, your job is to create a list of Tasks for a “My Weekly Planner” website. Information about the tasks should be stored in a JSON file.<br>Every time the “Importance” button is clicked the Importance should increases by one and the color should change", "weeklyPlanner.png", "http://netusil.codefactory.live/FE18-CR2-NetusilThomas/"),
  new project("Take Away Restaurtant", "Angular / SCSS", "", "Create at least 7 pages / components: ... The NavBar will be always showing, the same for the Footer. Home and About Us should have static content. Menu will hold dynamic content created from objects. On clicking on the Details button it should lead to the details page ...", "ristoranteOnlineShop.png", "http://netusil.codefactory.live/FE18-CR3-NetusilThomas/menu"),
  new project("Alumni website", "Groupwork / Angular / SCSS", "What we need", "The alumni website should consist of five sections: Home page, Alumni directory, Stories, Careers and Events. The purpose of the website is to give all necessary information about alumni", "frontEndProject.png", "http://netusil.codefactory.live/front-end-project/studentsdetails/0"),
]
