...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top p-md-2 bg-opacity-75 shadow">
  ...
  <div class="container-fluid">
    <!-- <a class="navbar-brand" routerLink=""><img src="./assets/images/Logo.avif" height="75px" alt="Ristorante Il Gambero Rosso"> Ristorante Il Gambero Rosso</a> -->
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show" href="create.php">New Item</a>
        </li> -->
        <!-- <li class="nav-item">
